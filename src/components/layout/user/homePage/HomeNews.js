...
function HomeNews() {
    const newsArr = [
        {
            title: 'Lễ khánh thành trung tâm công nghiệp chế biến hạt giống và nông sản hiện đại bậc nhất Việt Nam',
            date: '10/10/2020',
        },
    ...
    return (
        <div className='homenews'>
            <div className='homenews__lasted'>
                ...
                <NavLink to='/tin-tuc' className='homenews__lasted--viewmore'>
