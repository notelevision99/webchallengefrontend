...
// Business
import { GetProductBusiness, GetCateProductBusiness } from './business/product/ProductBusiness';
...
// Action redux
import { getProducts, getCategory, getCompany, getWeight } from './redux/action/ProductAction';
...
//Route
import UserRoute from './helpers/user/checkUserRole';
...
function App() {
    ...
    const userOnRedux = useSelector((state) => state.AuthenticationReducer.userInfo);
    ...
    return (
        <Router>
            ...
            <Switch>
                ...
                <UserRoute exact path='/thanh-toan' component={(Header, CheckoutPage, Footer)} />
                ...
                <ProtectedRoute path='/admin/categoriesblog/edit/:categoriesBlogId' component={EditCategoriesBlog} />
